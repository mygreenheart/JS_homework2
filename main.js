...
//алгоритм выбора фраз ролей и нумерация
res.forEach(function (e, index) {
    if (e.startsWith(roles[0])) {
        return arrRole1.push((index + 1) + (e.substr(0 + roles[0].length, e.length)));
    }
    if (e.startsWith(roles[1])) {
        arrRole2.push((index + 1) + (e.substr(0 + roles[1].length, e.length)));
    }
    if (e.startsWith(roles[2])) {
        arrRole3.push((index + 1) + (e.substr(0 + roles[2].length, e.length)));
    }
    if (e.startsWith(roles[3])) {
        arrRole4.push((index + 1) + (e.substr(0 + roles[3].length, e.length)));
    }
    return (index + 1) + ")" + e;
});
console.dir("***************************************************************************************"+ '\n' + roles[0] + '\n' + "***************************************************************************************");
for (let i in arrRole1) {
    console.dir(arrRole1[i]);
}

console.dir("***************************************************************************************"+ '\n' + roles[1] + '\n' + "***************************************************************************************");
for (let i in arrRole2) {
    console.dir(arrRole2[i]);
}

console.dir("***************************************************************************************"+ '\n' + roles[2] + '\n' + "***************************************************************************************");
for (let i in arrRole3) {
    console.dir(arrRole3[i]);
}

console.dir("***************************************************************************************"+ '\n' + roles[3] + '\n' + "***************************************************************************************");
for (let i in arrRole4) {
    console.dir(arrRole4[i]);
}

// for (var i = 0; i < res.length; i++) {
//     if (select.selectedIndex == 0) {
//         phrase.innerHTML += arrRole1;
//         document.body.append(phrase);
//     }
//     if(select.selectedIndex == 1){
//         phrase.innerHTML += arrRole2;
//     }
//     if(select.selectedIndex == 2){
//         phrase.innerHTML += arrRole3;
//     }
//     if(select.selectedIndex == 3){
//         phrase.innerHTML += arrRole4;
//     }
// }
